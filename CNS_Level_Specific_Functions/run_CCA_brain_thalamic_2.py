...
def run_CCA_thalamic2(subject, condition, srmr_nr, freq_band, sfreq, freq_type):
    ...
    if freq_type == 'high':
        ...
        save_path = "/data/pt_02718/tmp_data_2/cca_eeg_thalamic/" + subject_id + "/"
        append = ''
    else:
        ...
        save_path = "/data/pt_02718/tmp_data_2/cca_eeg_thalamic_low/" + subject_id + "/"
        append = '_low'
    os.makedirs(save_path, exist_ok=True)

    figure_path_spatial = f'/data/p_02718/Images_2/CCA_eeg_thalamic{append}/ComponentIsopotentialPlots/{subject_id}/'
    os.makedirs(figure_path_spatial, exist_ok=True)
    figure_path_time = f'/data/p_02718/Images_2/CCA_eeg_thalamic{append}/ComponentTimePlots/{subject_id}/'
    os.makedirs(figure_path_time, exist_ok=True)
    figure_path = f'/data/p_02718/Images_2/CCA_eeg_thalamic{append}/ComponentPlots/{subject_id}/'
