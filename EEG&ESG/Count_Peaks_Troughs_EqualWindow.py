...
if __name__ == '__main__':
    freq_band = 'sigma'
    srmr_nr_list = [1, 2]  # Can be 1 and 2
    ...
    for srmr_nr in srmr_nr_list:
        ...
        excel_fname = f'{save_path}Peaks_Troughs_EqualWindow.xlsx'
        ...
        for excel_sheetname, divisor in zip(['10%', '20%', '25%', '33%', '50%'], [10, 5, 4, 3, 2]):
            ...
            for data_type in ['bipolar', 'spinal', 'subcortical', 'cortical']:
                figure_path = f'/data/p_02718/Images{base}/Peak_Trough_Images_EqualWindow/{data_type}/'
