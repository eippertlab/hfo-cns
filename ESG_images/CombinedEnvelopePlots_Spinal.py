...
if __name__ == '__main__':
    ...
    if srmr_nr == 1:
        ...
        figure_path = '/data/p_02718/Images/ESG&CCA/Combined_Envelopes/'
        ...
        figure_path = '/data/p_02718/Images_2/ESG&CCA/Combined_Envelopes/'
        os.makedirs(figure_path, exist_ok=True)
    ...
    for freq_band in freq_bands:
        for condition in conditions:
            ...
            ax10 = ax1.twinx()
            for data_type in ['single_electrode', 'cluster_electrodes', 'CCA']:
                evoked_list = []
