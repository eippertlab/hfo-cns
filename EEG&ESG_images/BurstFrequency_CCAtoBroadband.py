...
if __name__ == '__main__':
    ...
    if srmr_nr == 1:
        ...
        figure_path = f'/data/p_02718/Images/BurstFrequencyAnalysis_CCAtoBroadband/'
        os.makedirs(figure_path, exist_ok=True)
        data_types = ['Spinal', 'Thalamic', 'Cortical']
        excel_fname = '/data/pt_02718/tmp_data/Peak_Frequency_400_1200_ccabroadband.xlsx'
    elif srmr_nr == 2:
        subjects = np.arange(1, 25)
        cond_names = ['med_mixed', 'tib_mixed']
        figure_path = f'/data/p_02718/Images_2/BurstFrequencyAnalysis_CCAtoBroadband/'
        os.makedirs(figure_path, exist_ok=True)
        data_types = ['Spinal', 'Thalamic', 'Cortical']
        excel_fname = '/data/pt_02718/tmp_data_2/Peak_Frequency_400_1200_ccabroadband.xlsx'
