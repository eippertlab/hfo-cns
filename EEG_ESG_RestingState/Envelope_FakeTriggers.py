...
if __name__ == '__main__':
    ...
    if data_type == 'Spinal':
        image_path_singlesubject = f"/data/p_02718/Images{add}/ESG/RestingState_Test/Envelope/SingleSubject/"
        image_path_grandaverage = f"/data/p_02718/Images{add}/ESG/RestingState_Test/Envelope/GrandAverage/"
    else:
        image_path_singlesubject = f"/data/p_02718/Images{add}/EEG/RestingState_Test/Envelope/SingleSubject/"
        image_path_grandaverage = f"/data/p_02718/Images{add}/EEG/RestingState_Test/Envelope/GrandAverage/"
    ...
    for cond_name in cond_names:  # Conditions (median, tibial)
        ...
        for subject in subjects:  # All subjects
            ...
            for epochs, evoked_list in zip([epochs_rest, epochs_trig],
                ...
                evoked_list.append(envelope)

                # Generate Single Subject Images
                tmin = 0.0
                tmax = 0.05
                plt.plot(evoked.times, envelope.get_data().reshape(-1)*10**6)
