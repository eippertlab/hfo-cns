    ...
    for data_type in ['spinal', 'subcortical', 'cortical']:
        for condition in conditions:
            ...
            for subject in subjects:
                ...
                figure_path = f"/data/p_02718/Images/CCA_RS_Task_ShorterWindow/{data_type}/"
                ...
                indices = [int((5000*0.1) + (window_times[0]-10/1000)*5000), int((5000*0.1) + (window_times[1]+80/1000)*5000)]
