...
if __name__ == '__main__':
    ...
    if srmr_nr == 1:
        ...
        excel_fname = f'/data/pt_02718/tmp_data/LowFreq_HighFreq_Amp_SNR_CCA.xlsx'
    elif srmr_nr == 2:
        subjects = np.arange(1, 25)
        cond_names = ['med_mixed', 'tib_mixed']
        excel_fname = f'/data/pt_02718/tmp_data_2/LowFreq_HighFreq_Amp_SNR_CCA.xlsx'
    ...
    for cond_name in cond_names:
        for data_type in data_types:
            ...
            for col_names in [col_names_low_high]:
