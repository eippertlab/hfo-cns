...
if __name__ == '__main__':
    ...
    if srmr_nr == 1:
        ...
        component_fname = '/data/pt_02718/tmp_data/Components_EEG_Updated_LF.xlsx'
        visibility_fname = '/data/pt_02718/tmp_data/Visibility_Updated_LF.xlsx'
        figure_path = '/data/p_02718/Images/CCA_eeg_low/SNR&EnvelopePeak/'
        ...
        component_fname = '/data/pt_02718/tmp_data_2/Components_EEG_Updated_LF.xlsx'
        visibility_fname = '/data/pt_02718/tmp_data_2/Visibility_Updated_LF.xlsx'
        figure_path = '/data/p_02718/Images_2/CCA_eeg_low/SNR&EnvelopePeak/'
        os.makedirs(figure_path, exist_ok=True)
    ...
    for condition in conditions:
        ...
        for subject in subjects:
            ...
            for c in np.arange(0, n_components):  # Loop through all components
                ...
                snr = (calculate_snr_lowfreqcca(evoked.copy(), noise_window, signal_window, sep_latency, 'cortical'))
                snr_comp.append(snr)
