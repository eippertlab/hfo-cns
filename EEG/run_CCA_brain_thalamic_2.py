...
def run_CCA_thalamic2(subject, condition, srmr_nr, freq_band, sfreq):
    ...
    ################################ Plotting Graphs #######################################
    figure_path_spatial = f'/data/p_02718/Images_2/CCA_eeg_thalamic/ComponentIsopotentialPlots/{subject_id}/'
    ...
    if plot_graphs:
        ...
        figure_path_time = f'/data/p_02718/Images_2/CCA_eeg_thalamic/ComponentTimePlots/{subject_id}/'
        ...
        figure_path = f'/data/p_02718/Images_2/CCA_eeg_thalamic/ComponentPlots/{subject_id}/'
