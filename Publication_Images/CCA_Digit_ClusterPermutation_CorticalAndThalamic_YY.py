...
if __name__ == '__main__':
    ...
    for data_type in data_types:
        ...
        figure_path = '/data/p_02718/Polished_2/Digits_Envelope_ClusterTestPerCondition_YY/'
        ...
        for condition in conditions:
            ...
            for evoked_list, trigger_name in zip([evoked_list_1, evoked_list_2, evoked_list_12], ['finger1', 'finger2', 'finger12']):
                ...
                for evoked in evoked_list:
                    ax.plot(
                        times, evoked.reshape(-1), color='gray', alpha=0.6,
                    )
                ...
                ax2.plot(times, T_obs, "tab:red")
                ax2.set_ylabel("t-values")
                ax2.set_xlim([0, 0.07])

                # Now force both yaxes to zero at same point
