...
if __name__ == '__main__':
    ...
    for data_type in data_types:
        ...
        figure_path_highlow = f'/data/p_02718/{fig_folder}/SingleTrialSNR_LowVsHigh_CCA/StrongestVsWeakest_ClusterBasedPermutation_LowSNRRank_BaselineCorr/{data_type}/'
