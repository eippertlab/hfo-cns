...
def run_CCA_brain(subject, condition, srmr_nr, freq_band, sfreq, freq_type):
    if freq_band != 'sigma':
    ...
    if freq_type == 'high':
        ...
        save_path = "/data/pt_02718/tmp_data/cca_halfdata_eeg/" + subject_id + "/"
        append = ''
    else:
        input_path = "/data/pt_02718/tmp_data/imported/" + subject_id + "/"
        fname = f'noStimart_sr{sfreq}_{cond_name}_withqrs_eeg.fif'
        save_path = "/data/pt_02718/tmp_data/cca_halfdata_eeg_low/" + subject_id + "/"
        append = '_low'
    os.makedirs(save_path, exist_ok=True)

    figure_path_spatial = f'/data/p_02718/Images/CCA_HalfData_eeg{append}/ComponentIsopotentialPlots/{subject_id}/'
    os.makedirs(figure_path_spatial, exist_ok=True)
    figure_path_time = f'/data/p_02718/Images/CCA_HalfData_eeg{append}/ComponentTimePlots/{subject_id}/'
    os.makedirs(figure_path_time, exist_ok=True)
    figure_path = f'/data/p_02718/Images/CCA_HalfData_eeg{append}/ComponentPlots/{subject_id}/'
