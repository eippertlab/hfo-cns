...
def run_CCA_shufflebyhalf(subject, condition, srmr_nr, freq_band):
    plot_graphs = True
    ...
    save_path = "/data/pt_02718/tmp_data/cca_shufflebyhalf/" + subject_id + "/"
    ...
    ################################ Plotting Graphs #######################################
    figure_path_spatial = f'/data/p_02718/Images/CCA_shufflebyhalf/ComponentIsopotentialPlots/{subject_id}/'
    ...
    if plot_graphs:
        ...
        figure_path_time = f'/data/p_02718/Images/CCA_shufflebyhalf/ComponentTimePlots/{subject_id}/'
        ...
        figure_path = f'/data/p_02718/Images/CCA_shufflebyhalf/ComponentPlots/{subject_id}/'
