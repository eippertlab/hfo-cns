# Plot grand average time courses and spatial patterns after application of CSP
...
if __name__ == '__main__':
    ...
    df = pd.read_excel(xls, 'CSP', keep_default_na=False)
    ...
    figure_path = '/data/p_02718/Images/CSP_eeg/GrandAverage/'
    ...
    for freq_band in freq_bands:
        for condition in conditions:
            ...
            for subject in subjects:
                ...
                input_path = "/data/pt_02718/tmp_data/csp_eeg/" + subject_id + "/"

                epochs = mne.read_epochs(input_path + fname, preload=True)

                # Need to pick channel based on excel sheet
                channel_no = df.loc[subject, f"{freq_band}_{cond_name}_comp"]
                channel = f'Comp {channel_no}'
