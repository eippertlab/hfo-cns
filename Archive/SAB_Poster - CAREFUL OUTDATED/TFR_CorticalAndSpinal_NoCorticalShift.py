...
if __name__ == '__main__':
    ...
    image_path = "/data/p_02718/SAB/TFRs/"
    ...
    for freq_type in ['upper']:  #, 'full'
        ...
        for cond_name in cond_names:  # Conditions (median, tibial)
            ...
            if cond_name == 'tibial':
                ...
                cortical_channel = ['Cz', 'FCz', 'C2', 'CPz', 'C1']
                ...
                cortical_channel = ['CP4', 'C4', 'CP6', 'P4', 'CP2']
            ...
            for subject in subjects:  # All subjects
                ...
                # # Apply relative time-shift depending on expected latency for cortical data
                ...
                # evoked_cortical.shift_time(shift, relative=True)
            ...
            if cond_name == 'median':
                ...
                if freq_type == 'full':
                    ...
                    vmin = 0
                    vmax = 4
            averaged_cortical.plot([0], baseline=iv_baseline, mode='ratio', cmap='jet',
            ...
            if freq_type == 'full':
                fname = f"NoCorticalShift_{trigger_name}_full_ratio"
            elif freq_type == 'upper':
                fname = f"NoCorticalShift_{trigger_name}_ratio"
            plt.tight_layout()
