...
# Shifted based on latency of underlying N20/P39
...
if __name__ == '__main__':
    ...
    figure_path = '/data/p_02718/Images/CCA_eeg_good/GrandAverage_GoodOnly_Shifted/'
    ...
    for freq_band in freq_bands:
        for condition in conditions:
            ...
            for subject in subjects:
                ...
                if cond_name == 'median':
                    sep_latency = df_time.loc[subject, "N20"]
                    expected = 20 / 1000
                elif cond_name == 'tibial':
                    sep_latency = df_time.loc[subject, "P39"]
                    expected = 39 / 1000
