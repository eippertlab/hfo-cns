...
if __name__ == '__main__':
    use_updated = True  # If true, use the updated component selection
    ...
    if use_updated:
        ...
        figure_path = '/data/p_02718/Images/CCA/Envelope_SingleSubject_Updated/'
        os.makedirs(figure_path, exist_ok=True)
        peak_path = '/data/pt_02718/BurstPeaks_Updated/'
        ...
        os.makedirs(figure_path, exist_ok=True)
        peak_path = '/data/pt_02718/BurstPeaks/'
        os.makedirs(peak_path, exist_ok=True)
    ...
    if single_subject_determination is True and use_updated is True:
        print('Error: Cannot use this with the current selection')
        exit()
    ...
    if not use_updated:
        if single_subject_determination:
            ...
            # print(df_r)
            df_r.to_excel(f'{peak_path}/Peaks_from_Envelope.xlsx')
