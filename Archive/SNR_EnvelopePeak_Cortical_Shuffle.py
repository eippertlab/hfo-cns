...
if __name__ == '__main__':
    ...
    if srmr_nr == 1:
        ...
        component_fname = '/data/pt_02718/tmp_data/Components_EEG_Shuffle_Updated.xlsx'
        visibility_fname = '/data/pt_02718/tmp_data/Visibility_Shuffle_Updated.xlsx'
        figure_path = '/data/p_02718/Images/CCA_eeg_shuffle/SNR&EnvelopePeak/'
        ...
        component_fname = '/data/pt_02718/tmp_data_2/Components_EEG_Shuffle_Updated.xlsx'
        visibility_fname = '/data/pt_02718/tmp_data_2/Visibility_Shuffle_Updated.xlsx'
        figure_path = '/data/p_02718/Images_2/CCA_eeg_shuffle/SNR&EnvelopePeak/'
        os.makedirs(figure_path, exist_ok=True)
    ...
    for condition in conditions:
        ...
        for subject in subjects:
            ...
            if srmr_nr == 1:
                ...
                input_path = "/data/pt_02718/tmp_data/cca_eeg_shuffle/" + subject_id + "/"
            elif srmr_nr == 2:
                fname = f"{freq_band}_{cond_name}.fif"
                input_path = "/data/pt_02718/tmp_data_2/cca_eeg_shuffle/" + subject_id + "/"
