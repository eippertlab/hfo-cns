        ...
        for data_type in data_types:
            for condition in conditions:  # Conditions (median, tibial)
                ...
                for subject in subjects:  # All subjects
                    ...
                    save_path = f'/data/pt_02718/{folder}/singletrial_snr_cca_gradient/{subject_id}/'
                    ...
                    # Point to contrast with
                    c_point = time_peak - 4/1000
                    ...
                    if channel_no != 0 and channel_no_low != 0:
                        ...
                        for n in np.arange(0, epochs_low.__len__()):
                            ...
                            if data_type == 'Cortical' and cond_name in ['tibial', 'tib_mixed']:
                                ...
                                # Get difference in amplitude at c_point and elsewhere
                                c_amps = evoked_low.copy().crop(tmin=c_point, tmax=c_point+0.1).get_data().reshape(-1)
                                c_amp = c_amps[0]
                                amplitude_diff = amplitude_low - c_amp
