...
if __name__ == '__main__':
    ...
    if srmr_nr == 1:
        figure_path = '/data/p_02718/Images/CCA_eeg_shuffle/GrandAverage_SpatialPatterns/'
        os.makedirs(figure_path, exist_ok=True)

        # Excel files
        xls = pd.ExcelFile('/data/pt_02718/tmp_data/Components_EEG_Shuffle_Updated.xlsx')
        ...
        figure_path = '/data/p_02718/Images_2/CCA_eeg_shuffle/GrandAverage_SpatialPatterns/'
        os.makedirs(figure_path, exist_ok=True)

        # Excel files
        xls = pd.ExcelFile('/data/pt_02718/tmp_data_2/Components_EEG_Shuffle_Updated.xlsx')
        df_cortical = pd.read_excel(xls, 'CCA')
        df_cortical.set_index('Subject', inplace=True)
