...
if __name__ == '__main__':
    ...
    # Taking only subjects with clear tangential component marked
    ...
    figure_path = '/data/p_02718/Polished/GrandAverageEnvelope_LowFreqTime_YY_TangentialOnly/'
    ...
    for condition in conditions:
        ...
        plt.tight_layout()
        plt.savefig(figure_path + f'GATangential_Time_{freq_band}_{cond_name}')
        plt.savefig(figure_path + f'GATangential_Time_{freq_band}_{cond_name}.pdf',
                    bbox_inches='tight',
                    format="pdf")
